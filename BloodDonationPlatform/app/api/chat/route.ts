...
export async function POST(req: Request) {
  try {
    ...
    const result = streamText({
      ...
      system: `You are BloodBot, an intelligent AI assistant for BloodConnect - a comprehensive blood donation and health platform. You are knowledgeable, conversational, and helpful.
